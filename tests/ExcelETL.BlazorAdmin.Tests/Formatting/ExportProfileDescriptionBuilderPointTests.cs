...
public class ExportProfileDescriptionBuilderPointTests
{
    ...
    [Fact]
    public void Parents_ApplicationThenGroupedPoints()
    {
        ...
        ColumnTexts(rule).Should().Equal(
            ...
            "Colonnes C à E : « X » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne du même nom à l'import, sinon vide : « PROLOCK VANNES » (C), « DEPROLOCK VANNES » (D), « POSE ÉTIQUETTES » (E).");
    }

    [Fact]
    public void Enfants_ApplicationThenGroupedPoints_WithTheExactNameNote()
    {
        ...
        ColumnTexts(rule).Skip(1).Should().Equal(
            ...
            "Colonnes C à E : « X » si l'élément est coché dans la colonne du même nom à l'import (nom identique, majuscules comprises), sinon vide : « PROLOCK VANNES » (C), « DEPROLOCK VANNES » (D), « POSE ÉTIQUETTES » (E).");
    }
    ...
    public void TwoMarkValues_GiveTwoGroups()
    {
        ...
        ColumnTexts(rule).Should().Equal(
            "Colonnes A à B : « X » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne du même nom à l'import, sinon vide : « A1 » (A), « A2 » (B).",
            "Colonnes C à D : « O » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne du même nom à l'import, sinon vide : « B1 » (C), « B2 » (D).");
    }
    ...
    public void PointWhoseHeaderDiffersFromTheColonneName_HasItsOwnSentence()
    {
        ...
        ColumnTexts(rule).Should().Equal(
            "Colonne A « PS941 » : « X » si l'élément est coché dans la colonne « ZÉRO ENERGIE EN PRESENCE EE (PS941) » à l'import (nom identique, majuscules comprises), sinon vide.");
    }
    ...
    public void GroupOfASingleColumn_IsDescribedAlone()
    {
        ...
        ColumnTexts(rule).Should().Equal(
            "Colonne A « PROLOCK VANNES » : « X » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne « PROLOCK VANNES » à l'import, sinon vide.",
            "Colonne B « POSE ÉTIQUETTES » : « O » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne « POSE ÉTIQUETTES » à l'import, sinon vide.");
    }
    ...
    public void NonConsecutiveGroup_ListsItsLetters_AndSitsAtItsFirstColumn()
    {
        ...
        ColumnTexts(rule).Should().Equal(
            "Colonnes A, C et D : « X » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne du même nom à l'import, sinon vide : « A1 » (A), « A2 » (C), « A3 » (D).",
            "Colonne B « B1 » : « O » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne « B1 » à l'import, sinon vide.");
    }
}
