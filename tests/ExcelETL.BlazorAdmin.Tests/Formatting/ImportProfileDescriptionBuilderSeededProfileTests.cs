    ...
    [
        ...
        ("Feuille PLATINES",
            [
                ...
                ("Si le champ « PoseeLe » est « DEBUT REL », l'élément est coché dans la colonne « RECEPTION DEBUT REL ».", false),
                ("Si le champ « DeposeeLe » est « DEBUT REL », l'élément est coché dans la colonne « RECEPTION DEBUT REL ».", false),
