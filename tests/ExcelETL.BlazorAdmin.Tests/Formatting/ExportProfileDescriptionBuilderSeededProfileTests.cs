    ...
    [
        ...
        ("Feuille Parents",
            [
                ...
                ("Colonnes O à AE : « X » si l'équipement, ou au moins un de ses éléments, est coché dans la colonne du même nom à l'import (sans tenir compte des majuscules ni des espaces en début ou fin), sinon vide : « VISITE PRÉALABLE CHANTIER » (O), « PROLOCK VANNES » (P), « DEPROLOCK VANNES » (Q), « ZÉRO ENERGIE EN PRESENCE EE (PS941) » (R), « POSE ÉTIQUETTES » (S), « RÉCEPTIONS ASSEMBLAGES : BOULONNÉS (PS938) OU TUBINGS » (T), « CONTRÔLE ETANCHÉITÉS » (U), « RECEPTION DEBUT MAD » (V), « RÉCEPTION PLATINES/TAMPONS PLEINS » (W), « RECEPTION DEBUT REL » (X), « PLATINES / TAMPONS PLEINS » (Y), « SYNCHRONISATION INSTRUMENTATION » (Z), « SOUPAPE : CONSTAT ENCRASSEMENT » (AA), « SOUPAPE : RÉCEPTION REPOSE AVEC ABSENCE BOUCHONS » (AB), « PF : SIGNATURE ÉTIQUETTE ET ACCORD COUPES » (AC), « PF : VALIDATION CONSTAT ENCRASSEMENT » (AD), « PF : ACCORD TRAVAUX FEU » (AE).", false),
            ]),
        ("Feuille Enfants",
            [
