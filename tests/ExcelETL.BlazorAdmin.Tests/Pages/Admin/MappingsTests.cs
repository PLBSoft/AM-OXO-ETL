...
public class MappingsTests : BunitContext
{
    ...
    [Fact]
    public async Task Mappings_WithExistingConfig_DisplaysConfigNameAndSheetCount() => await WithCultureAsync("en-US", async () =>
    {
    ...
    [Fact]
    public async Task Mappings_WithExistingConfig_AndFrenchCulture_DisplaysFrenchLabels() => await WithCultureAsync("fr-FR", async () =>
    {
        await SeedConfigAsync(BuildConfigWithOneSheetAndMapping());
        ...
        cut.Markup.Should().Contain("Configurations");
        cut.Markup.Should().Contain("1 feuille(s)");
    });

    [Fact]
    public void CreateConfig_WithValidName_AddsNewConfigToList() => WithCulture("en-US", () =>
    {
        var cut = Render<Mappings>();
    ...
    [Fact]
    public async Task SelectConfig_DisplaysItsSheetsAndCellMappings() => await WithCultureAsync("en-US", async () =>
    {
        await SeedConfigAsync(BuildConfigWithOneSheetAndMapping());
        var cut = Render<Mappings>();
    ...
    [Fact]
    public async Task AddSheet_WithValidInput_PersistsAndDisplaysNewSheet() => await WithCultureAsync("en-US", async () =>
    {
    ...
    [Fact]
    public async Task AddSheet_BeyondFiveSheets_DisplaysLocalizedDomainValidationError() => await WithCultureAsync("en-US", async () =>
    {
    ...
    [Fact]
    public async Task AddSheet_BeyondFiveSheets_AndFrenchCulture_DisplaysFrenchDomainValidationError() =>
        await WithCultureAsync("fr-FR", async () =>
        {
            ...
            cut.Markup.Should().Contain("impossible d'en ajouter plus de 5");
        });

    [Fact]
    public async Task AddCellMapping_WithValidInput_PersistsAndDisplaysNewMapping() => await WithCultureAsync("en-US", async () =>
    {
        var config = new ExtractionConfig("Purchase Order Template");
    ...
    [Fact]
    public async Task AddCellMapping_WithInvalidSourceCell_DisplaysLocalizedDomainValidationError() =>
    ...
    [Fact]
    public async Task AddCellMapping_WithInvalidSourceCell_AndFrenchCulture_DisplaysFrenchDomainValidationError() =>
        await WithCultureAsync("fr-FR", async () =>
        {
            var config = new ExtractionConfig("Purchase Order Template");
            config.AddSheet(new SheetConfig("Summary", sheetIndex: 0));
            ...
            cut.Markup.Should().Contain("référence Excel valide");
        });
}
