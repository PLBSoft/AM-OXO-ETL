...
public class LoginTests : BunitContext
{
    ...
    [Fact]
    public void LoginUser_WithValidCredentials_SignsInWithSuppliedCredentials()
    {
        _signInManagerMock
    ...
    [Fact]
    public void LoginUser_WithInvalidCredentials_DisplaysErrorMessage()
    {
        _signInManagerMock
    ...
    [Fact]
    public void LoginUser_WithEmptyEmail_DoesNotCallSignInManager()
    {
        var cut = Render<Login>();
        cut.Find("#Input\\.Password").Change("P@ssw0rd!");
        cut.Find("form").Submit();
